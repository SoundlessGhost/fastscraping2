          ...
          >
            ...
            <ul className="text-gray-600">
              <li>
                ...
                They are usually set in response to your actions, such as
              ...
              <li>
                ...
                and reporting information anonymously. This helps us improve our
              ...
              <li>
                <strong>Marketing Cookies:</strong> These cookies may be used to
            ...
            <ul className="text-gray-600">
              ...
              <li>
                <strong>Google Tag Manager:</strong> For managing website tags
              </li>
              <li>
            ...
            <p className="text-gray-600">
              ...
              or "Preferences" menu of your browser. The following links provide
            ...
            <p className="text-gray-600">
              ...
              of our website may not function properly. Essential cookies cannot
              be disabled as they are necessary for the basic operation of the
              website.
            </p>
            ...
            <p className="text-gray-600">
              For more information about cookies and how they are used, you can
              visit:
            </p>
            <ul className="text-gray-600">
              <li>
