        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600">
              FastScraping ("we," "our," or "us") is committed to protecting
              your privacy. This Privacy Policy explains how we collect, use,
              disclose, and safeguard your information when you visit our
              website fastscraping.com and use our services.
            </p>
            <p className="text-gray-600">
            ...
            <p className="text-gray-600">
              ...
              name, job title, phone number, and any other information you
              choose to provide.
            </p>
            ...
            <p className="text-gray-600">
              ...
              (GDPR). Our legal bases for processing include consent,
