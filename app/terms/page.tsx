    ...
    <main className="min-h-screen bg-cream">
      ...
      <section className="relative pt-32 pb-12 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            <p className="mt-4 text-gray-600">Last updated: March 9, 2026</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-12 pb-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-2xl font-bold text-primary mt-0">
              1. Agreement to Terms
            </h2>
            <p className="text-gray-600">
              These Terms of Service ("Terms") constitute a legally binding
              agreement between you and FastScraping ("Company," "we," "us," or
              "our") concerning your access to and use of the fastscraping.com
              website and our web scraping and data extraction services
            ...
            <p className="text-gray-600">
              FastScraping provides web scraping, data extraction, and data
              pipeline services. Our Services include:
            </p>
            ...
            <p className="text-gray-600">
              ...
              enter into a binding agreement to use our Services. By using our
            ...
            <p className="text-gray-600">
              ...
              your use of data obtained through our Services complies with all
            ...
            <ul className="text-gray-600">
              ...
              <li>
                Engage in any activity that could harm our systems or other
                users
              </li>
            ...
            <p className="text-gray-600">
              Pricing for our Services is provided on a custom basis or as
              displayed on our website for self-serve products (e.g., Scrayz
              API). All prices are in US Dollars unless otherwise specified.
            </p>

            <h3 className="text-xl font-semibold text-primary">6.2 Payment</h3>
            <p className="text-gray-600">
              Payment is due as specified in your service agreement or at the
              time of purchase for self-serve products. We accept payment via
              wire transfer, PayPal, and credit cards (via Stripe).
            </p>

            <h3 className="text-xl font-semibold text-primary">6.3 Refunds</h3>
            <p className="text-gray-600">
              Refunds are handled on a case-by-case basis. Setup fees are
              generally non-refundable. Monthly service fees may be prorated
              upon termination.
            </p>
            ...
            <p className="text-gray-600">
              Data extracted through our Services is delivered to you for your
              use in accordance with applicable laws. We do not claim ownership
              of data we extract on your behalf.
            </p>
            ...
            <p className="text-gray-600">
              You are solely responsible for ensuring that your collection,
              storage, and use of data complies with all applicable laws,
              including data protection regulations (e.g., GDPR, CCPA).
            </p>
            ...
            <p className="text-gray-600">
              ...
              including but not limited to software, designs, text, graphics,
              and logos, are owned by FastScraping and are protected by
            ...
            <p className="text-gray-600">
              ...
              of our business relationship. This includes technical information,
            ...
            <p className="text-gray-600">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, FASTSCRAPING SHALL NOT BE
              LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR
              PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS OF PROFITS,
              DATA, OR BUSINESS OPPORTUNITIES, REGARDLESS OF THE CAUSE OF ACTION
            ...
            <p className="text-gray-600">
              ...
              secure, or error-free, or that any data obtained will be accurate
              or complete.
            </p>
            ...
            <p className="text-gray-600">
              You agree to indemnify, defend, and hold harmless FastScraping and
            ...
            <p className="text-gray-600">
              ...
              breach of these Terms. Upon termination, your right to use our
            ...
            <p className="text-gray-600">
              ...
              resolved through arbitration or in the courts of Bangladesh.
            </p>
