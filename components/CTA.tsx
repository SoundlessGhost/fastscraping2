  ...
  return (
    <section className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute inset-0 pattern-grid" style={{ backgroundSize: '60px 60px' }} />
      </div>
      ...
      <motion.div
        ...
        className="absolute top-20 right-[10%] w-32 h-32 bg-white/5 rounded-3xl"
      />
      <motion.div
        animate={{ 
          y: [0, 20, 0],
        ...
        className="absolute bottom-20 left-[15%] w-20 h-20 bg-white/5 rounded-2xl"
      />
      <motion.div
        animate={{ scale: [1, 1.2, 1] }}
        transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut' }}
        className="absolute top-1/2 right-[30%] w-4 h-4 bg-mint/30 rounded-full"
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold font-display text-white tracking-tight leading-tight">
              Ready to Scale Your{' '}
              <span className="text-mint">Data Pipeline?</span>
            </h2>
            <p className="mt-6 text-lg text-white/80 leading-relaxed">
              Get a free sample within 48-72 hours. We'll match or beat your current vendor's pricing while delivering better quality and coverage.
            </p>
