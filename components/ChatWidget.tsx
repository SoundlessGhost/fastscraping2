...
// Configuration - Update this with your chat server URL
...
function ChatWidgetContent() {
  ...
  useEffect(() => {
    ...
    socket.on("new_message", (data) => {
      ...
      if (!isOpen && data.message.sender_type !== "visitor") {
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 w-[380px] h-[550px] bg-white rounded-2xl shadow-2xl z-[9999] flex flex-col overflow-hidden"
          >
            {/* Header */}
