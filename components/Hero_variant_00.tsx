  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-cream pt-20 pb-32">
      ...
      <motion.div
        ...
        className="absolute top-40 right-[8%] w-28 h-28 bg-sage/20 rounded-3xl pointer-events-none"
      />
      <motion.div
        ...
        className="absolute bottom-32 right-[12%] w-20 h-20 bg-mint/30 rounded-2xl pointer-events-none"
      />
      <motion.div
        animate={{ scale: [1, 1.3, 1] }}
        transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
        className="absolute top-52 left-[8%] w-5 h-5 bg-primary/30 rounded-full pointer-events-none"
      />
      {/* Decorative Elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              <Link
                ...
                className="group inline-flex items-center justify-center px-7 py-3.5 bg-primary text-white font-semibold rounded-xl text-md transition-all duration-300 hover:shadow-glow hover:-translate-y-0.5"
              >
              ...
              <Link
                href="/solutions"
                className="group inline-flex items-center justify-center px-7 py-3.5 bg-white text-primary font-semibold rounded-xl text-lg border-2 border-primary/20 hover:border-primary hover:bg-sage/10 transition-all duration-300"
              >
                View Solutions
              </Link>
            </motion.div>
          ...
          <div className="hidden lg:block relative lg:pl-8">
            <motion.div
              ...
              className="relative bg-white rounded-2xl shadow-2xl overflow-hidden border border-sage/20"
            >
              {/* Dashboard header */}
              <div
            ...
            <motion.div
              ...
              className="absolute -top-4 -right-4 bg-white rounded-2xl shadow-xl p-4 border border-sage/20"
            >
              <div className="flex items-center gap-3">
                <div
