...
const benefits = [
  {
    ...
    description: 'We create complete digital identities — unique fingerprints, persistent cookies, aged browser profiles. Not just IP rotation.',
    highlights: ['Canvas & WebGL Spoofing', 'TLS Fingerprint Match', 'Session Persistence'],
  },
  {
    icon: Shield,
    title: 'Anti-Bot Bypass Experts',
    description: 'We reliably bypass Cloudflare, DataDome, PerimeterX, and Akamai. Most vendors give up — we solve it.',
    highlights: ['Cloudflare Turnstile', 'DataDome ML Detection', 'PerimeterX Behavioral'],
  },
  {
    icon: RefreshCw,
    title: 'Recurring Data Pipelines',
    description: 'Not one-off scripts. We build infrastructure for daily, weekly, or monthly data delivery with quality checks.',
    highlights: ['Scheduled Delivery', 'Auto-Adaptation', 'Quality Monitoring'],
  },
  {
    icon: Clock,
    title: '48-72 Hour Sample Delivery',
    description: 'Quick turnaround on proof-of-concept. See results before committing. Match or beat your current vendor.',
    highlights: ['Fast POC', 'Quality Sample', 'Fair Pricing'],
  },
  {
    icon: Users,
    title: 'Silent Backend Vendor',
    description: 'We operate invisibly behind your brand. Your clients never know we exist. White-label partnership model.',
    highlights: ['White Label', 'B2B Partnership', 'Zero Attribution'],
  },
  {
    icon: Lock,
    title: 'Enterprise Security',
    description: 'GDPR compliant operations. Secure data delivery via API, SFTP, or S3. Encrypted pipelines end-to-end.',
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <p className="mt-6 text-lg text-gray-600 leading-relaxed">
              We're not a proxy provider. We're not a simple scraping tool. We're your complete data extraction team — with the technical depth to solve what others can't.
            </p>
            ...
            <div className="mt-10 grid grid-cols-2 gap-6">
              <div className="p-4 bg-white rounded-2xl border border-sage/20">
                ...
                <p className="text-sm text-gray-600 mt-1">Months with longest client</p>
              </div>
              <div className="p-4 bg-white rounded-2xl border border-sage/20">
                <p className="text-3xl font-bold text-primary font-display">0</p>
                <p className="text-sm text-gray-600 mt-1">Account bans for clients</p>
              </div>
            </div>
            
            {/* Comparison */}
            <div className="mt-10 p-6 bg-white rounded-2xl border border-sage/20">
              <h4 className="font-semibold text-primary mb-4">vs Alternatives</h4>
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                  <div>
                    <span className="font-medium">vs In-house:</span>
                    <span className="text-gray-600 ml-1">Too expensive, breaks constantly</span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                  <div>
                    ...
                    <span className="text-gray-600 ml-1">Cookie-based, ban risk</span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                  <div>
                    ...
                    <span className="text-gray-600 ml-1">Proxy only, still need scraper</span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                  <div>
                    ...
                    <span className="text-gray-600 ml-1">No scale, no reliability</span>
                  </div>
                </div>
              </div>
            </div>
